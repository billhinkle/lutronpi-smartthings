 ...
 *	v2.0.0.00	2018-04-22	wjh			Modified for PJ2-2B Picos
...
metadata {
	...
	tiles (scale: 2) {
        standardTile("mainfavorite", "favorite", width: 6, height: 1, canChangeIcon: true, canChangeBackground: true) {
			state "favorite", label: 'FAVE:[${currentValue}]', defaultState: true, nextState: "><", action: "pushFavorite", icon: "http://i65.tinypic.com/23jfx55.png"
			state "0", label: '', icon: "http://i65.tinypic.com/23jfx55.png"
		}

 		standardTile("btn1", "button1", width: 3, height: 3, decoration: "flat") {
 		...
 		standardTile("btn2", "button2", width: 3, height: 3, decoration: "flat") {
        ...
        standardTile("picoIcon", "", width: 3, height: 3, decoration: "flat", canChangeIcon: true) {
			state "default", label:'', icon: "http://i65.tinypic.com/23jfx55.png", backgroundColor: "#ffffff"
		}
    ...
    preferences {
    	input name: "faveButton", type: "number", title: "Favorite", 
        			defaultValue: 0, range: "0..2", description: "Things Favorite [0=none]", required: false
