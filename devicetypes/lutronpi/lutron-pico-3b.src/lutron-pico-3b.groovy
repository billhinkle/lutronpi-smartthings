 ...
 *	v2.0.0.00	2018-04-22	wjh			Modified for PJ2-3Bxxxx Picos
 ...
 */
metadata {
	definition (name: "Lutron Pico 3B", namespace: "lutronpi", author: "Bill Hinkle")  {
		capability "Refresh"
		capability "Actuator"
	...
	tiles (scale: 2) {
        standardTile("mainfavorite", "favorite", width: 6, height: 1, canChangeIcon: true, canChangeBackground: true) {
			state "favorite", label: 'FAVE:[${currentValue}]', defaultState: true, nextState: "><", action: "pushFavorite", icon: "http://i64.tinypic.com/m832xc.png"
			state "0", label: '', icon: "http://i64.tinypic.com/m832xc.png"
		}
 		...
 		standardTile("btn3", "button3", width: 3, height: 2, decoration: "flat") {
        ...
        standardTile("picoIcon", "", width: 3, height: 3, decoration: "flat", canChangeIcon: true) {
			state "default", label:'', icon: "http://i64.tinypic.com/m832xc.png", backgroundColor: "#ffffff"
		}
		...
		main "mainfavorite"
		details(["btn1", "picoIcon", "btn3", "holdKey", "btn2", "holdLockKey", "lInfo", "favorite"])
	}
    
    preferences {
    	input name: "faveButton", type: "number", title: "Favorite", 
        			defaultValue: 0, range: "0..3", description: "Things Favorite [0=none]", required: false
